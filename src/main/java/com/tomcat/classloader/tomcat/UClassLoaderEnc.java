 ...
 * 可以解密文件并加载
 */
public class UClassLoaderEnc extends WebappClassLoader {
	...
	public UClassLoaderEnc(String path) {
	 ...
	 * @param parent
	 */
	public UClassLoaderEnc(ClassLoader parent) {
		super(parent);
	}
