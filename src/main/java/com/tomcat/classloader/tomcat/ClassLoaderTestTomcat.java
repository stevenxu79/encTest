...
//		String mLibPath="E:\\lib\\xny\\encSpringTest-0.0.1-SNAPSHOT";
		String mLibPath="E:\\lib\\xny\\encSpringTest-0.0.1-SNAPSHOT_encrypt";
		
//		UClassLoader diskLoader1 = new UClassLoader(mLibPath);
		
		UClassLoaderEnc diskLoader1 = new UClassLoaderEnc(mLibPath);
		Class cls1 = null;
		try {
		//加载class文件
//		String cl="com.seassoon.suichao.xny.Test1";
		String cl="org.springframework.core.LocalVariableTableParameterNameDiscoverer";
		 cls1 = diskLoader1.loadClass(cl);
